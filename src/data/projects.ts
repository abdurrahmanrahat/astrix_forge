export const projects = [
  {
    _id: "660f1a2b3c4d5e6f7a8b9c12",
    slug: "ghl-hvac-automation-system",
    title:
      "HVAC Automation System with GHL & AI (CRM + Funnel + Booking + AI Calling)",
    category: "automation",
    summary:
      "Complete GoHighLevel automation system for HVAC companies that captures leads, automates customer communication, books service appointments, and manages the sales pipeline using AI.",
    thumbnail: "/images/projects/hvac-upwork-banner.png",
    videoUrl:
      "https://res.cloudinary.com/dpebdrnjf/video/upload/v1783697394/hvac_c9hb9c.mp4",
    isVideoMobileRecording: false,
    challenge:
      "HVAC companies often struggle with delayed responses, missed service requests, inconsistent follow-ups, and scattered customer communication, causing valuable jobs to be lost.",
    solution:
      "Built a complete GoHighLevel automation system with a website funnel, AI chatbot, lead qualification workflow, booking calendar, CRM pipeline, automated follow-ups, Facebook & Instagram automation, and AI calling integration.",
    features: [
      "High-converting HVAC landing page",
      "AI chatbot for instant customer support",
      "Service request qualification workflow",
      "Integrated booking calendar",
      "CRM pipeline for lead management",
      "Automated email and SMS follow-ups",
      "Facebook & Instagram message automation",
      "AI calling integration for faster customer engagement",
      "Centralized Conversations inbox",
      "Complete workflow automation from inquiry to booking",
    ],
    result:
      "The system automated the complete customer journey, helping the business respond faster, increase booked service calls, improve follow-up consistency, reduce missed opportunities, and manage every lead from one centralized platform.",
    meta: {
      type: "CRM & Service Automation",
      industry: "HVAC",
      timeline: "1–2 weeks",
    },
    tools: [
    ...
    liveUrl: "https://hvac-niche.vibepreview.com",
  },
  {
    _id: "660f1a2b3c4d5e6f7a8b9c10",
    slug: "ghl-dental-clinic-automation-system",
    title:
      "Dental Clinic Automation System with GHL & AI (CRM + Booking + Workflow + Chatbot)",
    category: "automation",
    summary:
      "Complete GoHighLevel automation system for dental clinics that captures patient inquiries, qualifies leads, automates follow-ups, and converts them into booked appointments using CRM and AI.",
    thumbnail: "/images/projects/dentist-upwork-banner.png",
    videoUrl:
      "https://res.cloudinary.com/dpebdrnjf/video/upload/v1783697323/Automated_Dental_Booking_and_Follow-Up_System_x2ylvb.mp4",
    isVideoMobileRecording: false,
    challenge:
      "Dental clinics often miss new patients because inquiries are answered late, appointments are managed manually, and follow-ups are inconsistent, resulting in lost bookings and administrative overload.",
    solution:
      "Built a complete GoHighLevel patient acquisition system with a landing page, AI chat, patient qualification flow, booking calendar, CRM pipeline, automated email and SMS reminders, urgent case detection, and follow-up workflows.",
    features: [
      "High-converting dental landing page for patient acquisition",
      "AI chatbot for instant patient responses and FAQs",
      "Patient qualification workflow before booking",
      "Integrated appointment booking calendar",
      "Custom CRM pipeline to track every patient inquiry",
      "Automated email and SMS reminders",
      "Urgent dental case detection and priority routing",
      "Automated follow-up sequences for unbooked patients",
      "Centralized Conversations inbox for patient communication",
      "Complete workflow automation to reduce manual tasks",
    ],
    result:
      "The automation streamlined the entire patient journey from inquiry to appointment, improving response times, increasing bookings, reducing missed opportunities, and allowing the clinic team to spend more time with patients instead of administrative work.",
    meta: {
      type: "CRM & Patient Automation",
    ...
    liveUrl: "https://dental.astrixforge.com",
  },
  {
    _id: "661f2b3c4d5e6f8a8b9c0123",
    slug: "whatsapp-ai-agent-with-appointment-booking",
    title: "WhatsApp AI Agent With Appointment Booking",
    category: "ai-agent",
    summary:
      "AI-powered WhatsApp automation agent that handles text, voice, and image messages, understands user intent, routes conversations to the right agent, supports appointment booking, and sends automated WhatsApp replies.",
    thumbnail: "/images/projects/n8n-whatsapp-ai_agent-booking.png",
    videoUrl:
      "https://res.cloudinary.com/dpebdrnjf/video/upload/v1777907398/WhatsApp_AI_Agent_Demo_with_Voice_and_Image_jcq0kd.mp4",
    isVideoMobileRecording: false,
    challenge:
      "Many businesses rely on WhatsApp for customer communication but struggle with slow replies, repetitive questions, appointment requests, voice notes, image messages, and fragmented conversations where users send multiple short messages one after another.",
    solution:
      "Built an n8n-powered WhatsApp AI agent that receives text, voice, and image messages, processes each input, and routes the conversation to the correct AI agent for booking, general information, or casual conversation. The workflow includes a smart waiting system using Redis to combine multiple short messages before replying, making the conversation feel more natural. It also supports appointment booking through Google Calendar, information lookup from Google Sheets, and automated WhatsApp responses.",
    features: [
      "WhatsApp text message automation",
      "Voice message download and transcription",
      "Image message processing",
      "Smart waiting system for multiple short messages",
      "AI-based intent routing",
      "Separate agents for booking, information, and conversation",
      "Appointment booking support with Google Calendar",
      "Business information lookup from Google Sheets",
      "Automated WhatsApp replies",
      "Redis-based temporary message handling",
    ],
    result:
      "The workflow helped create a more natural and efficient WhatsApp customer support experience by reducing manual replies, handling different message types, combining fragmented user messages, routing requests correctly, and supporting appointment booking automatically.",
    meta: {
      type: "WhatsApp AI Automation",
  ...
  {
    _id: "660f1a2b3c4d5e6f7a8b9c09",
    slug: "ghl-coaches-automation-system",
    title:
      "Coaches Automation System with GHL & AI (CRM + Funnel + Workflow + Pipelines + Chatbot)",
    category: "automation",
    summary:
      "Complete GoHighLevel system for coaches that captures leads, qualifies prospects, automates follow-ups, and converts them into booked consultations using workflows, CRM, and AI.",
    thumbnail: "/images/projects/ghl-coaches.jpg",
    videoUrl:
      "https://res.cloudinary.com/dpebdrnjf/video/upload/v1777904884/GoHighLevel_Coaching_Automation_From_Leads_to_Bookings_fc5eqz.mp4",
    isVideoMobileRecording: false,
    challenge:
      "Coaching businesses often lose potential clients because of slow responses, weak follow-up, unqualified leads, and no clear system to move prospects from interest to booked consultations.",
    solution:
      "Built a complete GoHighLevel coaching funnel system with a landing page, lead qualification form, booking calendar, CRM pipeline, automated email/SMS follow-ups, appointment reminders, AI chat support, and social media message automation.",
    features: [
      "High-converting coaching funnel page with clear CTA",
      "Lead qualification form to collect prospect details and filter serious leads",
      "Integrated booking calendar for instant consultation scheduling",
      "Custom CRM pipeline for tracking leads from New Lead to Closed",
      "Automated email and SMS follow-ups for faster response and nurturing",
      "Appointment confirmation and reminder automation to improve show-up rates",
      "No-booking follow-up workflow to re-engage leads who do not schedule",
      "AI chat widget to answer questions, qualify leads, and guide users to booking",
      "Facebook and Instagram message automation for lead capture and follow-up",
      "Centralized Conversations inbox for managing all client communications",
    ],
    result:
      "The system helped automate the full coaching client journey, from lead capture to booking and follow-up, reducing manual work, improving response speed, increasing consultation bookings, and creating a smoother prospect experience.",
    meta: {
      type: "Funnel & CRM Automation",
      industry: "Coaching",
      timeline: "1–2 weeks",
    },
    tools: [
    ...
    liveUrl: "https://coaches.astrixforge.com",
  },
  {
    _id: "660f1a2b3c4d5e6f7a8b9c11",
    slug: "ghl-air-conditioning-automation-system",
    title:
      "Air Conditioning Business Automation with GHL & AI (CRM + Booking + Funnel + Workflow)",
    category: "automation",
    summary:
      "Complete GoHighLevel automation system for Air Conditioning companies that captures service inquiries, qualifies customers, automates follow-ups, and books more service appointments.",
    thumbnail: "/images/projects/ac-upwork-banner.png",
    videoUrl:
      "https://res.cloudinary.com/dpebdrnjf/video/upload/v1783697350/air-conditioning_mjdvpn.mp4",
    isVideoMobileRecording: false,
    challenge:
      "Air Conditioning businesses frequently lose service requests because customers don't receive quick responses, appointments require manual coordination, and follow-ups are often forgotten.",
    solution:
      "Built a complete GoHighLevel lead generation and booking system featuring a landing page, AI chat, service qualification workflow, appointment calendar, CRM pipeline, and automated email and SMS communication.",
    features: [
      "Lead generation landing page for AC service requests",
      "AI chatbot for instant customer responses",
      "Service request qualification workflow",
      "Integrated appointment booking calendar",
      "CRM pipeline for managing service inquiries",
      "Automated email and SMS reminders",
      "Lead nurturing and follow-up automation",
      "Conversations inbox for customer communication",
      "Business workflow automation",
      "End-to-end service booking process",
    ],
    result:
      "The automation created a faster and more organized customer journey, helping the business respond instantly, reduce missed opportunities, increase booked service appointments, and eliminate repetitive administrative work.",
    meta: {
      type: "Lead Generation & CRM Automation",
    ...
    liveUrl: "https://airconditioning.astrixforge.com",
  },
  {
  ...
  {
    _id: "660f1a2b3c4d5e6f7a8b9c08",
    slug: "ghl-real-estate-lead-automation-system",
    title: "Real Estate Lead Automation System with GHL & AI",
    category: "automation",
    summary:
      "Complete GoHighLevel system that captures real estate leads, nurtures them, automates follow-ups, and converts them into booked consultations using AI and workflows.",
    thumbnail: "/images/projects/ghl-real-estate.png",
    videoUrl:
      "https://res.cloudinary.com/dpebdrnjf/video/upload/v1777118120/ghl-real-estate-automation-system_dpq8lv.mp4",
    isVideoMobileRecording: false,
    challenge:
      "Real estate businesses were losing potential buyers due to slow response times, missed inquiries, lack of structured follow-ups, and no centralized system to manage leads, bookings, and conversations.",
    solution:
      "Built a complete GoHighLevel automation system with a high-converting funnel, structured CRM pipeline, automated SMS/email follow-ups, booking system, and AI-powered communication to capture, nurture, and convert leads efficiently.",
    features: [
      "High-converting funnel (Landing → Lead capture → Booking flow)",
      "Custom CRM pipeline for lead tracking (New Lead → Qualified → Booked → Closed)",
      "Automated SMS & email follow-ups with nurture sequences",
      "Integrated booking system with calendar scheduling",
      "AI chatbot for website and automated Facebook & Instagram message responses",
      "AI calling agent for lead capture and qualification",
      "Centralized Conversations inbox for managing all communications",
    ],
    result:
      "The system enabled instant lead capture, automated follow-ups, and streamlined booking processes, improving response speed, increasing booking rates, and eliminating manual lead chasing.",
    meta: {
      type: "CRM Automation",
    ...
    liveUrl: "https://real-estate.astrixforge.com",
  },
  {
